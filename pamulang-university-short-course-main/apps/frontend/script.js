...
async function connectWallet() {
  ...
  try {
    ...
    // Nonaktifkan tombol setelah berhasil terhubung
...
if (window.ethereum) {
  window.ethereum.on('accountsChanged', (accounts) => {
    ...
    if (accounts.length === 0) {
      // User memutuskan koneksi wallet
      ...
      addressEl.textContent = newAccount;
  ...
  window.ethereum.on('chainChanged', (chainId) => {
    ...
    // Muat ulang halaman saat jaringan berubah (direkomendasikan oleh MetaMask)
